		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#customauthcustomauth-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customauthcustomauth-display": {
								"semanticObject": "customauthcustomauth",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customauth.customauth",
									"url": sap.ui.require.toUrl("customauth/customauth")
								}
							}
						}
					}
